...
public class CcddMathExpressionHandler {
     ...
     *
     * @return The result of the evaluated expression; null if the supplied text
     *         doesn't evaluate to a numeric value (not a mathematical expression or
    ...
    /**********************************************************************************************
     * Perform the operation (# operator #), as specified by the supplied nest
     * level's operator, using the supplied value and the nest level's running value
     *
     * @param dValue    first value
     *
     * @param nestLevel nest level that determines the second value and the operator
     *
     * @return true if the operation is valid; false if an error occurs (divide by
     *         zero condition exists)
     *********************************************************************************************/
    private static boolean performOperation(Double dValue, NestLevel nestLevel) {
        ...
        // The nest level has a value
            ...
            case '&':
                nestLevel.setValue(
                        Double.parseDouble(String.valueOf((nestLevel.getValue().longValue() & dValue.longValue()))));
                break;
