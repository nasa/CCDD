...
public class CcddVariableDialog extends CcddDialogHandler {
    ...
    /**********************************************************************************************
     * Create the variable paths and names dialog. This is executed in a separate
    ...
    private void initialize() {
        ...
        CcddBackgroundCommand.executeInBackground(ccddMain, new BackgroundCommand() {
            ...
            protected void execute() {
                ...
                varPathSepFld = new JTextField(
                        ccddMain.getProgPrefs().get(VARIABLE_PATH_SEPARATOR, DEFAULT_VARIABLE_PATH_SEP), 5);
                ...
                // them
                // to the dialog panel
                final JLabel typeNameSepLbl = new JLabel(
                        "<html>Enter data type/variable name<br>&#160;separator character(s)");
                ...
                tableTree = new CcddTableTreeHandler(ccddMain,
                        new CcddGroupHandler(ccddMain, null, ccddMain.getMainFrame()), TableTreeType.STRUCTURE_TABLES,
                        DEFAULT_PROTOTYPE_NODE_NAME, DEFAULT_INSTANCE_NODE_NAME, ccddMain.getMainFrame());
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        ...
                        if (varPathSepFld.getText().matches(".*[\\[\\]].*")
                            ...
                            new CcddDialogHandler().showMessageDialog(CcddVariableDialog.this,
                                    "<html><b>Invalid character(s) in separator field(s)", "Invalid Input",
                ...
                btnPrint.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        variableTable.printTable(
                                "Project '" + ccddMain.getDbControlHandler().getDatabaseName() + "' Variables", null,
                                CcddVariableDialog.this, PageFormat.LANDSCAPE);
                    }
                });
     ...
     *
     * @return Array of variables matching the filter tables, or all variables if no
            ...
            if (filterTables.isEmpty()) {
                ...
                variableList.add(new Object[] { CcddUtilities.highlightDataType(variableName),
                        variableHandler.getFullVariableName(variableName, varPathSepFld.getText(),
                                hideDataTypeCb.isSelected(), typeNameSepFld.getText()) });
            }
