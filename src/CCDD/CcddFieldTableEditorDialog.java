...
public class CcddFieldTableEditorDialog extends CcddFrameHandler {
    ...
    private void buildUpdates() {
        ...
        // VALUES - THERE'S NO WAY TO SET (OR SEE) THE OVERWRITE BEHAVIOR IN THIS EDITOR.
        // COULD (1) DECIDE THAT CHANGES MADE HERE ARE NEVER PROPAGATED TO THE FIELDS BELONGING TO
        // TABLES OF THE CHANGED TYPE OR (2) NOT ALLOW CHANGES TO TABLE TYPE FIELD VALUES FROM
        // THIS EDITOR.  DID IMPLEMENT CHANGE SO THAT INHERITED FIELDS ARE DELETED IF THE DEFAULT IS
        // DELETED.
