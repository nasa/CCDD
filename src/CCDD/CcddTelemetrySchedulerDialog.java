...
public class CcddTelemetrySchedulerDialog extends CcddDialogHandler implements CcddSchedulerDialogInterface {
    ...
    /**********************************************************************************************
     * Create the telemetry scheduler dialog. This is executed in a separate thread
        ...
        CcddBackgroundCommand.executeInBackground(ccddMain, new BackgroundCommand() {
            ...
            protected void execute() {
                ...
                allVariableTree = new CcddTableTreeHandler(ccddMain,
                        TableTreeType.INSTANCE_STRUCTURES_WITH_PRIMITIVES_AND_RATES, ccddMain.getMainFrame());
                ...
                for (Enumeration<?> element = allVariableTree.getRootNode().preorderEnumeration(); element
                    ...
                    allVariableTreePaths.add(
                            allVariableTree.getFullVariablePath(((ToolTipTreeNode) element.nextElement()).getPath()));
                }
                ...
                // Clear Rate button
                btnClearRate = CcddButtonPanelHandler.createButton("Clear Rate", UNDO_ICON, KeyEvent.VK_R,
                ...
                // Add Sub-msg button
                btnAddSubMessage = CcddButtonPanelHandler.createButton("Add Sub-msg", INSERT_ICON, KeyEvent.VK_A,
                ...
                btnAssign = CcddButtonPanelHandler.createButton("Assign Msgs", AUTO_CREATE_ICON, KeyEvent.VK_M,
                ...
                btnStore.addActionListener(new ValidateCellActionListener() {
                    ...
                    protected void performAction(ActionEvent ae) {
                        ...
                        // storing the changes
                        if (isChanges() && new CcddDialogHandler().showMessageDialog(CcddTelemetrySchedulerDialog.this,
                                "<html><b>Store changes?", "Store Changes", JOptionPane.QUESTION_MESSAGE,
    ...
    protected void windowCloseButtonAction() {
        ...
        if (activeSchHandler.getSchedulerEditor().getTable().isLastCellValid()
                && (!isChanges() || new CcddDialogHandler().showMessageDialog(CcddTelemetrySchedulerDialog.this,
