...
*
*   \brief
*     Dialog for the user to select script files to store to or retrieve from the database. The
...
public class CcddScriptStorageDialog extends CcddDialogHandler {
    ...
    // Array of file references containing the selected script file(s) (store) or
    // the selected script file path (retrieve)
    ...
    private void initialize() {
        ...
        case STORE:
            ...
            scriptFile = new CcddDialogHandler().choosePathFile(ccddMain, ccddMain.getMainFrame(), null, "script",
                    scriptHandler.getExtensions(), true, "Select Script(s) to Store",
            ...
            if (scriptFile != null) {
                    ...
                    for (FileEnvVar file : scriptFile) {
                        ...
                        if (!dbTable.isTableExists(InternalTable.SCRIPT.getTableName(file.getName()),
                                ...
                                || new CcddDialogHandler().showMessageDialog(ccddMain.getMainFrame(),
                                        "<html><b>Overwrite existing stored script '</b>" + file.getName() + "<b>'?",
                ...
                // No script file is selected
                    ...
                    new CcddDialogHandler().showMessageDialog(ccddMain.getMainFrame(),
                            "<html><b>Must select a script to store", "Store Script(s)", JOptionPane.WARNING_MESSAGE,
        ...
        case DELETE:
                    ...
                    if (showOptionsDialog(ccddMain.getMainFrame(), dialogPnl, "Retrieve Script(s)",
                        ...
                        for (String script : selectedScripts) {
                            ...
                            fileIOHandler.retrieveScriptFromDatabase(script,
                                    new File(scriptFile[0].getAbsolutePath() + File.separator + script));
                        }
                    }
                }
            ...
            // No scripts are stored in the database
                ...
                // retrieve/delete
                new CcddDialogHandler().showMessageDialog(ccddMain.getMainFrame(),
                        "<html><b>Project '</b>" + dbControl.getDatabaseName() + "<b>' has no scripts",
                        (dialogType == ScriptIOType.RETRIEVE ? "Retrieve" : "Delete") + " Script(s)",
    ...
    private JPanel createPathSelectionPanel() {
        ...
        pathFld = new JTextField(
                ModifiablePathInfo.SCRIPT_PATH.getPath().replaceAll("\\" + File.separator + "\\.$", ""));
        ...
        pathFld.setBorder(BorderFactory.createCompoundBorder(
    ...
    protected boolean verifySelection() {
        ...
        try {
            ...
            new CcddDialogHandler().showMessageDialog(CcddScriptStorageDialog.this, "<html><b>" + ce.getMessage(),
                    "Missing Input", JOptionPane.WARNING_MESSAGE, DialogOption.OK_OPTION);
