...
public class CcddFrameHandler extends JFrame {
     ...
     * last button in the frame's button panel (close/cancel)
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Placeholder for any actions required when this window is closed. This is
     * intended to handle special actions for non-modal windows
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the total width of the table to be displayed in the window which is the
     * sum of the minimum column sizes
     *
     * @return Total width, in pixels, of the minimum column sizes of the table to
    ...
    /**********************************************************************************************
     * Set the total width of the table to be displayed in the window which is the
     * sum of the minimum column sizes
     *
     * @param width total width, in pixels, of the minimum column sizes of the table
    ...
    /**********************************************************************************************
     * Placeholder for method to verify the the window box selection(s) prior to
     * closing
     *
     * @return true
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Extract the window's button(s) from the supplied panel, then find the widest
    ...
    /**********************************************************************************************
     * Create the window. If no buttons are provided (lower panel) then create the
     * buttons and button listeners needed based on the option type
     *
     * @param parent         window to center the window over
     *
     * @param upperComponent upper window components
     *
     * @param buttonPnl      panel containing the window's buttons; null if a
     *                       defined option type is used
     *
     * @param defaultBtn     reference to the JButton that is actuated if the Enter
     *                       key is pressed; null to have no default button
     *
    ...
    protected void createFrame(Component parent, JComponent upperComponent, JPanel buttonPnl, JButton defaultBtn,
        ...
        setPreferredSize(new Dimension(
                Math.min(tableWidth + ModifiableSpacingInfo.DIALOG_BORDER_PAD.getSpacing() * 2,
