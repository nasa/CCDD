/**
 * CFS Command & Data Dictionary frame handler. Copyright 2017 United States
...
public class CcddFrameHandler extends JFrame
{
    ...
    // Sum of the minimum column widths, in pixels, of the table to display a
    // table within a window
     ...
     * the last button in the frame's button panel (close/cancel)
     *************************************************************************/
    protected void windowCloseButtonAction()
    {
        // Send a button press event for the last button in the frame's button
    ...
    /**************************************************************************
     * Extract the window's button(s) from the supplied panel, then find the
                               ...
                               DialogOption optionType)
    {
        ...
        // Set the default close operation so that the window frame's close
        // button doesn't automatically exit the window. Instead, if this close
        // button is pressed a button press event is sent to the last button on
        // the window's button panel
        ...
        addWindowListener(new WindowAdapter()
        {
            ...
            {
                // Perform action needed when the window's frame close button
                // is pressed
        ...
        // Set the preferred width to the smaller of (1) the width of all of
