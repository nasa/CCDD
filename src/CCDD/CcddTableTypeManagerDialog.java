...
public class CcddTableTypeManagerDialog extends CcddDialogHandler {
    ...
    // Storage for the type definition in the event it must be restored after being
    // deleted
     ...
     *********************************************************************************************/
    CcddTableTypeManagerDialog(CcddMain ccddMain, CcddTableTypeEditorDialog editorDialog,
     ...
     * operation
     *
     * @param commandError     false if the database commands successfully
     *                         completed; true if an error occurred and the changes
     *                         were not made
     *
     * @param fieldDefinitions list of field definitions; null if this is not a copy
     *                         operation
     *
     * @param tableNames       array of deleted table names; null if this is not a
     *                         delete operation
     *********************************************************************************************/
    ...
    private void initialize() {
        ...
        GridBagConstraints gbc = new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.LINE_START,
                GridBagConstraints.BOTH, new Insets(ModifiableSpacingInfo.LABEL_VERTICAL_SPACING.getSpacing() / 2, 0,
        ...
        case NEW:
            ...
            addRadioButtons("None", true,
                    new String[][] { { "None", "" }, { TYPE_STRUCTURE, "" }, { TYPE_COMMAND, "" } }, null,
                    "Add columns required for table type", false, radioBtns, gbc);
            gbc.gridy++;
            ...
            if (showOptionsDialog(editorDialog, dialogPnl, "New Type", DialogOption.CREATE_OPTION) == OK_BUTTON) {
                ...
                tableTypeHandler.createReplaceTypeDefinition(typeNameFld.getText(), "",
                        DefaultColumn.getDefaultColumnDefinitions(getRadioButtonSelected(), true));
        ...
        case DELETE:
            ...
            if (showMessageDialog(editorDialog, "<html><b>Delete table type '</b>" + activeTypeName + "<b>'?",
                    "Delete Type", JOptionPane.QUESTION_MESSAGE, DialogOption.DELETE_OPTION) == OK_BUTTON) {
    ...
    private void addTypeNameField(String labelText, String intialName, JPanel dialogPnl, GridBagConstraints dialogGbc) {
        ...
        typeNameFld.setBorder(BorderFactory.createCompoundBorder(
