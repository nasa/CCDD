...
public class CcddUtilities {
    ...
    private static enum HTMLTag {
        // The order of the HTML enumerations prevents accidental conversion of special
        // characters
        // within a tag from being interpreted as a tag character (e.g., the '<' in
        // '<br>' would be
        // converted to a '&lt;' if the break tag appears prior to the less than tag in
        // the list)
         ...
         *
         * @return The input text with the HTML reserved characters replaced with the
         *         equivalent HTML tag
         *****************************************************************************************/
    ...
    /**********************************************************************************************
     * HTML tag storage class. HTML tags that are removed from the input string are
     * store in this object along with the string index location
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Check if two arrays contain the same set of items. The order of the items in
     * each set has no effect on the match outcome
     *
    ...
    /**********************************************************************************************
     * Repeat any embedded double quotes, then bound the supplied text with double
     * quotes
     *
     * @param text text string for which to add double quotes; a null string is
     *             replaced by a blank
     *
     * @return The supplied text string with any embedded double quotes repeated,
     *         and bounded with double quotes
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * For each of the supplied text strings repeat any embedded double quotes, then
     ...
     *
     * @return Each of the supplied text strings with any embedded double quotes
     *         repeated, then bound with double quotes and separate each result with
     *         a comma
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Split the supplied text string into an array, divided at commas, ignoring
     * commas within quotes. Remove the excess double quotes from the array members
     *
     * @param text text string to split
     *
     * @return Text string divided into separate components, split at commas
     *         (including any surrounding white space characters), accounting for
     *         commas within double quotes, and with the excess double quotes
     *         removed
     *********************************************************************************************/
     ...
     * separator character(s), ignoring the separator character(s) within quotes.
     ...
     *                     returned as blanks. Set to -1 to split the text into as
     *                     many parts as there are separators in the text
     *
    ...
    /**********************************************************************************************
     * Convert the supplied array of text items into a single string with the items
     * separated by commas. If the length of the string exceeds a specified maximum
     * then shorten the string to the maximum, find the last comma, truncate the
     * string, and add an indication of how many other items are in the list
     *
     * @param itemArray array of text items to combine
     *
     * @return The array of text items converted to a single, comma-separated
    ...
    /**********************************************************************************************
     * Separate a command line string into an array of arguments. Account for
     * quoting (single and double) of arguments within the string
     *
     * @param argString command line argument string
     *
     * @return Array containing the separate command line arguments with any quotes
     *         removed
     *********************************************************************************************/
     ...
     *
     * @return Character that separates an enumeration value from its corresponding
     *         label
     *********************************************************************************************/
     ...
     * @param enumeration        {@literal enumeration in the format <enum value><enum value separator><enum label>[<enum value separator>...][<enum pair separator>...]}
     *
     * @param enumValueSeparator character used to separate an enumeration value
     *                           from its corresponding label
     *
    ...
    /**********************************************************************************************
     * Create a copy of a single dimensional array with a specified number of extra
     * columns appended
     *
     ...
     *
     * @return Array containing the data from the input array plus the specified
     *         number of extra, empty columns appended
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Create a copy of a two-dimensional array with a specified number of extra
     * columns appended
     *
     * @param array      array to copy
     *
     ...
     *
     * @return List of string arrays containing the data from the input list minus
     ...
     *
     * @return Array with the specified member moved to the new position and the
     *         other members adjusted to accommodate the move
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Concatenate the contents of two one-dimensional arrays to produce a third
     * array
     *
    ...
    /**********************************************************************************************
     * Concatenate the contents of two two-dimensional arrays to produce a third
     * array
     *
     * @param <T>    generic type parameter
     *
    ...
    /**********************************************************************************************
     * Convert an object array to a string array. The number of columns in the input
     * array do not have to have the same number of columns
     *
     ...
     *
     * @param text         StringBuilder string from which to remove the trailing
     *                     characters
     *
     * @param trailingText trailing characters to remove
     *
    ...
    /**********************************************************************************************
     * Convert the array into a single string and remove the leading and trailing
     * brackets
     *
     * @param array array of strings
     *
     * @return Single string containing the strings from the array, separated by a
     *         comma and a space
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Replace any HTML break tags with spaces, remove the remaining HTML tag(s)
     * from the supplied text, and replace special character markers with the
     * special character if recognized, else with a blank
     *
     * @param text string from which to remove the HTML tags
     *
     * @return Input string with spaces replacing breaks, minus any HTML tag(s), and
    ...
    /**********************************************************************************************
     * Replace any HTML break tags with line feeds or spaces (depending on the input
     * flag), remove the remaining HTML tag(s) from the supplied text, and replace
     * special character markers with the special character if recognized, else with
     * a blank
     *
     * @param text           string from which to remove the HTML tags
     *
     * @param preserveBreaks true to replace breaks with line feeds; false to
     *                       replace breaks with spaces
     *
     * @return Input string with line feeds or spaces replacing breaks, minus any
     *         HTML tag(s), and with special character markers replaced
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Add the HTML tags to the supplied text to change the font color to the one
     * specified
     *
    ...
    /**********************************************************************************************
     * Escape any PostgreSQL reserved characters in the supplied string so that when
     * used in a regular expression the characters are recognized properly
     *
     * @param text string in which to escape any reserved characters
     *
     * @return String with any reserved PostgreSQL characters escaped so that they
     *         are recognized by a regular expression
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Convert the supplied text string to HTML, replacing the HTML special
     * characters in the text string with the equivalent HTML tags
     *
     ...
     * @param inputText    string to format for HTML
     *
     * @param ignoreBreaks true to ignore replacing line feeds with breaks; false to
     *                     replace line feeds with breaks
     *
     * @return Input string converted to HTML format
     *********************************************************************************************/
     ...
     *
     * @return true if the specified text string is present in the supplied list
     *         (case insensitive)
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Insert line breaks into the supplied string so as to limit the maximum length
     * of each line to the value specified. If the supplied string is formatted for
     * HTML then the HTML tags are removed prior to determining the line breaks
     * insertion position(s). Once the line breaks are added the HTML tags are
     * restored. A non-HTML input string is converted to HTML format, including
     * conversion of any special characters
     *
     * @param inputText string to format for wrapping
     *
     * @param maxLength maximum length, in characters, to wrap the text
     *
     * @return The input text, converted to HTML format (if not already), with line
     *         breaks inserted to limit the line length to the maximum specified;
     *         null if the input string is null or blank
     *********************************************************************************************/
            ...
            while (inputText.length() > maxLength) {
                ...
                if (inputText.substring(0, index + padLength).contains(HTMLTag.BREAK.getHTMLTag())) {
                    ...
                    inputText = inputText.substring(
                            inputText.indexOf(HTMLTag.BREAK.getHTMLTag()) + HTMLTag.BREAK.getHTMLTag().length());
                }
    ...
    /**********************************************************************************************
     * Highlight any text matching the search text in the the specified text
     * component
     *
     ...
     *
     * @return true if the supplied text contains a match to the specified search
     *         pattern
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Display a dialog for a generic exception, showing the cause and the stack
     * trace
     *
    ...
    /**********************************************************************************************
     * Update the list of remembered items with the specified string. This is used
     * by the search and server auto-completion lists, and by the lists of
     * previously opened projects and tables
     *
     * @param text     item to add to the list. The item is placed at the head of
     *                 the list. The list size is constrained to the maximum number
     *                 specified when the field was created
     *
    ...
    /**********************************************************************************************
     * Get the list of remembered items as a single, delimited string. This is used
     * by the search and server auto-completion lists, and by the lists of
     * previously opened projects and tables
     *
     * @param itemList list containing the items to combine into a single string
     *
     * @return String containing the items from which the text is extracted,
