...
/**************************************************************************************************
 * CFS Command and Data Dictionary script data access class. This class contains
...
public class CcddScriptDataAccessHandler {
     ...
     *
     * @param groupNames       list containing the names of any groups referenced in
     *                         the script association
     *
     * @param parent           reference to the GUI component from which this class
     *                         was generated (script dialog if executing from within
     ...
     *
     * @param tableType table type (case insensitive). All structure table types are
     *                  combined and are referenced by the type name "Structure",
     *                  and all command table types are combined and are referenced
     *                  by the type name "Command". The table type is converted to
     *                  the generic type ("Structure" or "Command") if the specified
     *                  type is a representative of the generic type
     *
     ...
     *
     * @return Character length of the longest string in the supplied array; null if
     *         an input is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the number of characters in longest string in each column of an array of
     * strings
     *
     * @param strgArray array of string arrays
     *
     * @param minWidths array of initial minimum widths; null to use zero as the
     *                  minimum for each column
     *
     * @return Character length of the longest string in each column of the supplied
     *         array; null if any of the inputs is invalid
     *********************************************************************************************/
     ...
     * reflect daylight saving time); yyyy is the year, as four decimal digits
     *
     ...
     *
     * @return Array where each row contains a user-defined data type name and its
     *         corresponding C-language, size (in bytes), and base data type values
     *********************************************************************************************/
     ...
     * @param dataType name of the data type to test
     *
     * @return true if the supplied data type is an integer (signed or unsigned);
     *         false otherwise
     *********************************************************************************************/
     ...
     * @param dataType name of the data type to test
     *
     * @return true if the supplied data type is an unsigned integer; false
     *         otherwise
     *********************************************************************************************/
     ...
     * @param dataType name of the data type to test
     *
     * @return true if the supplied data type is a character or string; false
     *         otherwise
     *********************************************************************************************/
     ...
     *
     * @return C type for the specified data type; returns null if the data type
     *         doesn't exist or isn't a primitive type
     *********************************************************************************************/
     ...
     * @param dataType name of the primitive data type
     *
     * @return Base type for the specified data type; returns null if the data type
     *         doesn't exist or isn't a primitive type
     *********************************************************************************************/
     ...
     *
     * @return Number of bytes required to store the data type; returns 0 if the
     ...
     * @param dataType name of the structure or primitive data type
     *
     * @return Number of bits required to store the data type; returns 0 if the data
     *         type doesn't exist
     *********************************************************************************************/
     ...
     *
     * @param encoding "SINGLE_CHAR" to get the single character encoding (e.g., "I"
     ...
     *                 insensitive
     *
     * @return ITOS encoded form of the data type in the format requested (e.g.,
     *         "int32" and "LITTLE_ENDIAN" returns "I12345678"); returns the data
     *         type, unmodified, if the data type is a table (i.e., it's a
     *         structure), or null if the data type is unrecognized
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the array of root structure table names (child table names are excluded).
     * Convenience method that assumes the table type is a structure
     *
     * @return Array of root structure table names; returns a blank if an instance
    ...
    /**********************************************************************************************
     * Get the array of the root table names for the supplied table type. Note that
     * only structure tables can have child tables so using this method for
     * non-structure tables returns the same list of tables as
     * getTableNames(typeName)
     *
     * @param tableType table type (case insensitive). All structure table types are
     *                  combined and are referenced by the type name "Structure",
     *                  and all command table types are combined and are referenced
     *                  by the type name "Command"
     *
     * @return Array of root table names for the type specified; returns a blank if
     ...
     *
     * @return Number of rows of data in the table for the table type "structure";
     *         -1 if an instance of the structure table type doesn't exist
     *********************************************************************************************/
     ...
     *
     * @return Number of rows of data in the table of the type "command"; -1 if an
     ...
     *                  by the type name "Command"
     *
     * @return Number of rows of data in the table for the table type specified; -1
     *         if an instance of the table type doesn't exist
     *********************************************************************************************/
     ...
     *
     * @return Number of rows of data for all table types; 0 if there is no table
     *         data
     *********************************************************************************************/
     ...
     *
     * @return Prototype structure table name to which the current row's parameter
     *         belongs; returns a blank if an instance of the structure table type
     ...
     *         returns a blank if an instance of the command table type or the row
     *         doesn't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the prototype table name for the type specified to which the specified
     * row's parameter belongs
     *
     * @param tableType table type (case insensitive). All structure table types are
     *                  combined and are referenced by the type name "Structure",
     *                  and all command table types are combined and are referenced
     ...
     * @param row       table data row index
     *
     * @return Prototype table name to which the current row's parameter belongs;
     *         return a blank if an instance of the table type or the row doesn't
     *         exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get array of all structure table names, including paths for child structure
     * tables, referenced in the table data. Convenience method that specifies the
     * table type as "structure"
     *
     ...
     *
     * @return Array of all prototype structure table names; returns an empty array
     *         if an instance of the structure table type doesn't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get array of all table names, including paths for child structure tables,
     * referenced in the table data of the specified table type
     *
     * @param tableType table type (case insensitive). All structure table types are
     *                  combined and are referenced by the type name "Structure",
     *                  and all command table types are combined and are referenced
     *                  by the type name "Command"
     *
     * @return Array of all table names, including paths for child structure tables,
     *         represented by the table type; returns an empty array if an instance
    ...
    /**********************************************************************************************
     * Get array of all table names referenced in the table data of the specified
     * table type
     *
     * @param tableType     table type (case insensitive). All structure table types
     *                      are combined and are referenced by the type name
     *                      "Structure", and all command table types are combined
     *                      and are referenced by the type name "Command"
     *
     * @param prototypeOnly true to return only the prototype name for any child
    ...
    /**********************************************************************************************
     * Get array of all table names, including paths for child structure tables,
     * referenced in the table data for all table types
     *
     * @return Array of all table names, including paths for child structure tables,
     *         referenced in the table data; empty array if no tables exists in the
     *         data
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the variable name at the specified row in the structure data, with any
     * macro name replaced by its corresponding value
     *
     * @param row table data row index
     *
     * @return Variable name at the specified row in the structure data, with any
     *         macro replaced by its corresponding value; null if the row index is
     *         invalid
     *********************************************************************************************/
     ...
     * @param row          table data row index
     *
     * @param expandMacros true to replace any macros with their corresponding
     *                     value; false to return the data with any macro names in
     *                     place
     *
     * @return Variable name at the specified row in the structure data; null if the
     ...
     * @param row table data row index
     *
     * @return Variable data type at the specified row in the structure data; null
    ...
    /**********************************************************************************************
     * Get the variable array size at the specified row in the structure data, with
     * any macro name replaced by its corresponding value
     *
     * @param row table data row index
     *
     * @return Variable array size at the specified row in the structure data, with
     *         any macro replaced by its corresponding value; null if the row index
     *         is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the variable array size at the specified row in the structure data. Macro
     * expansion is controlled by the input flag
     *
     * @param row          table data row index
     *
     ...
     *                     place
     *
     * @return Variable array size at the specified row in the structure data; null
     *         if the row index is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the variable bit length at the specified row in the structure data, with
     * any macro name replaced by its corresponding value
     *
     * @param row table data row index
     *
     * @return Variable bit length at the specified row in the structure data, with
     *         any macro replaced by its corresponding value; null if the row index
     *         is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the variable bit length at the specified row in the structure data. Macro
     * expansion is controlled by the input flag
     *
     * @param row          table data row index
     *
     ...
     *                     place
     *
     * @return Variable bit length at the specified row in the structure data; null
     *         if the row index is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the variable description at the specified row in the structure data, with
     * any macro name replaced by its corresponding value
     *
     * @param row table data row index
     *
     * @return Variable description at the specified row in the structure data, with
     *         any macro replaced by its corresponding value; null if the row index
     ...
     * @return Variable description at the specified row in the structure data, with
     *         any embedded macro(s) left in place; null if the row index is invalid
     *         or no column has the 'Description' input type
     *********************************************************************************************/
     ...
     *                     place
     *
     * @return Variable description at the specified row in the structure data; null
     *         if the row index is invalid or no column has the 'Description' input
     *         type
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the variable units at the specified row in the structure data, with any
     * macro name replaced by its corresponding value
     *
     * @param row table data row index
     *
     * @return Variable units at the specified row in the structure data, with any
     *         macro replaced by its corresponding value; null if the row index is
     ...
     *
     * @return Variable units at the specified row in the structure data, with any
     *         embedded macro(s) left in place; null if the row index is invalid or
     *         no column has the 'Units' input type
     *********************************************************************************************/
     ...
     *                     place
     *
     * @return Variable units at the specified row in the structure data; null if
     *         the row index is invalid or no column has the 'Units' input type
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the variable enumeration(s) at the specified row in the structure data,
     * with any macro name replaced by its corresponding value
     *
     * @param row table data row index
     *
     * @return Array containing the variable enumeration(s) at the specified row in
     *         the structure data, with any macro replaced by its corresponding
     *         value; null if the row index is invalid
     *********************************************************************************************/
     ...
     *
     * @return Array containing the variable enumeration(s) at the specified row in
     *         the structure data, with any embedded macro(s) left in place; null if
     ...
     *
     * @return Array containing the variable enumeration(s) at the specified row in
     *         the structure data; null if the row index is invalid
     *********************************************************************************************/
     ...
     * @param row table data row index
     *
     * @return Array containing the variable rate(s) at the specified row in the
     *         telemetry structure data; an empty array if the row index is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the command name at the specified row in the command data, with any macro
     * name replaced by its corresponding value
     *
     * @param row table data row index
     *
     * @return Command name at the specified row in the command data, with any macro
     ...
     *                     place
     *
     * @return Command name at the specified row in the command data; null if the
     *         row index is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the command code at the specified row in the command data, with any macro
     * name replaced by its corresponding value
     *
     * @param row table data row index
     *
     * @return Command code at the specified row in the command data, with any macro
     *         replaced by its corresponding value; null if the row index is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the command code (as a string) at the specified row in the command data.
     * Macro expansion is controlled by the input flag
     *
     * @param row          table data row index
     *
     ...
     *                     place
     *
     * @return Command code (as a string) at the specified row in the command data;
     ...
     * @param row table data row index
     *
     * @return Command argument variable path+name at the specified row in the
     *         command data, with any macro replaced by its corresponding value;
     *         null if the row index is invalid
     *********************************************************************************************/
     ...
     *
     * @return Command argument variable path+name at the specified row in the
     *         command data, with any embedded macro(s) left in place; null if the
     *         row index is invalid
     *********************************************************************************************/
     ...
     *
     * @return Command argument variable path+name at the specified row in the
     *         command data; null if the row index is invalid
     *********************************************************************************************/
     ...
     * @param row table data row index
     *
     * @return Type name referenced in the specified row of the structure table type
     *         data
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the table type name referenced in the specified row of the command table
     * type data. Convenience method that specifies the table type as "command"
     *
     * @param row table data row index
     *
     * @return Type name referenced in the specified row of the command table type
     *         data
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the the table type name referenced in the specified row of the specified
     * table type data. The data for all structure (command) types are combined.
     * This method provides the means to retrieve the specific table type to which
     * the row data belongs based on its "generic" type
     *
     * @param tableType table type (case insensitive). All structure table types are
     *                  combined and are referenced by the type name "Structure",
     *                  and all command table types are combined and are referenced
     ...
     * @param row       table data row index
     *
     * @return Type name referenced in the specified row of the specified table type
     *         data. This the table's actual type name and not the generic
     *         'Structure' or 'Command' used to access combined structure or command
     *         table data. Returns a blank if the table type name or row is invalid
     *********************************************************************************************/
     ...
     *
     * @param tableName name of the table. For a child structure this includes the
     *                  path
     *
     * @return Type name for the specified table. This the table's actual type name
     *         and not the generic 'Structure' or 'Command' used to access combined
     *         structure or command table data
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the column names for the table referenced on the specified row of the
    ...
    /**********************************************************************************************
     * Get the table column names for the table referenced on the specified row of
     * the table data for the table type specified
     *
     * @param tableType table type (case insensitive). All structure table types are
     *                  combined and are referenced by the type name "Structure",
     *                  and all command table types are combined and are referenced
     ...
     *
     * @param typeName table type name. This is the table's actual type name and not
     *                 the generic 'Structure' or 'Command' used to access combined
     *                 structure or command table data
     *
     ...
     * which they are referenced; that is, the structure array is arranged so that a
     * structure appears in the array prior to a structure that references it
     *
     * @return Array containing the names of the prototype structures in the order
     *         in which they are referenced; an empty array is returned if no
    ...
    /**********************************************************************************************
     * Get the full name of the variable in the specified row of the structure data
     * in the application’s native format, which includes the variables in the
     * structure path separated by commas, and with the data type and variable names
     ...
     *         separated by a period; returns a blank if the row is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get a variable's full name which includes the variables in the structure path
     * separated by underscores, and with the data types removed. In case there are
     * any array member variable names in the full name, replace left square
     * brackets with # underscores and remove right square brackets (example:
     * a[0],b[2] becomes a_0_b_2)
     *
     * @param row table data row index
     *
     * @return The variable's full path and name with each variable in the path
     *         separated by an underscore, and with the data types removed; returns
     *         a blank if the row is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get a variable's full name which includes the variables in the structure path
     * separated by the specified separator character(s), and with the data types
     * removed. In case there are any array member variable names in the full name,
     * replace left square brackets with # underscores and remove right square
     ...
     *
     * @return The variable's full path and name with each variable in the path
     *         separated by the specified separator character(s), and with the data
     *         types removed; returns a blank if the row is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get a variable's full name which includes the variables in the structure path
     * separated by the specified separator character(s). In case there are any
     * array member variable names in the full name, replace left square brackets
     * with # underscores and remove right square brackets (example: a[0],b[2]
     * becomes a_0separatorb_2). Data types may be excluded or retained, based on
     * the input flag
     *
     * @param row               table data row index
     *
     * @param varPathSeparator  character(s) to place between variable path members
     *
     * @param excludeDataTypes  true to remove the data types from the variable path
     *                          + name
     *
     * @param typeNameSeparator character(s) to place between data types and
     *                          variable names
     *
     * @return The variable's full path and name with each variable in the path
     *         separated by the specified separator character(s); returns a blank if
     *         the row is invalid
     *********************************************************************************************/
     ...
     * brackets (example: a[0],b[2] becomes a_0separatorb_2)
     *
     * @param variablePath     variable path in the format
     *                         rootTable[,structureDataType1.variable1
     *                         [,structureDataType2.variable2[,...]]]
     *
     * @param variableName     variable name in the format
     ...
     * @return The variable's full path and name with each variable in the path
     *         separated by the specified separator character(s) and with the data
     *         types removed; returns a blank if the variable path + name doesn't
     ...
     *                          [,structureDataType2.variable2[,...]]]
     *
     * @param variableName      variableName in the format
     *                          primitiveDataType.variable
     *
     * @param varPathSeparator  character(s) to place between variable path members
     *
     ...
     * with # underscores and remove right square brackets (example: a[0],b[2]
     * becomes a_0separatorb_2). Data types may be excluded or retained, based on
     * the input flag. Any macro embedded in the variable name is expanded
     *
     * @param fullName          variable path + name in the format
     *                          rootTable[,structureDataType1.variable1
     *                          [,structureDataType2.variable2
     ...
     * @return The variable's full path and name with each variable in the path
     *         separated by the specified separator character(s); returns a blank if
     *         the variable path + name doesn't exist in the project database. Any
     *         macro embedded in the variable name is expanded
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the structure path to which the specified row's data belongs with any
     * embedded macro replaced by its corresponding value. Convenience method that
     * assumes the table type is "structure"
     *
     * @param row table data row index
     *
     * @return The structure path to the current row's parameter with any embedded
     *         macro replaced by its corresponding value; returns a blank if an
     *         instance of the table type doesn't exist or the row number is
     *         invalid. The path starts with the root table name and is followed by
     *         a comma and then the parent structure and variable name(s) that
     *         define(s) the table's path. Each parent and its associated variable
     *         name are separated by a period. Each parent/variable pair in the path
    ...
    /**********************************************************************************************
     * Get the structure path to which the specified row's data belongs with any
     * embedded macro(s) left in place. Convenience method that assumes the table
     * type is "structure"
     *
     * @param row table data row index
     *
     * @return The structure path to the current row's parameter with any embedded
     *         macro(s) left in place; returns a blank if an instance of the table
     *         type doesn't exist or the row number is invalid. The path starts with
     *         the root table name and is followed by a comma and then the parent
     *         structure and variable name(s) that define(s) the table's path. Each
     *         parent and its associated variable name are separated by a period.
     *         Each parent/variable pair in the path is separated by a comma. The
     *         format is:
     *
     *         rootTable[,structureDataType1.variable1[,structureDataType2.variable2[...]]]
     *********************************************************************************************/
     ...
     *         replaced by its corresponding value; returns a blank if an instance
     *         of the table type doesn't exist or the row number is invalid. The
     *         path starts with the root table name. For structure tables the root
     *         name is followed by a comma and then the parent structure and
     *         variable name(s) that define(s) the table's path. Each parent and its
     *         associated variable name are separated by a period. Each
     *         parent/variable pair in the path is separated by a comma. The format
     *         is:
     *
     *         rootTable[,structureDataType1.variable1[,structureDataType2.variable2[...]]]
     *********************************************************************************************/
     ...
     * @param row       table data row index
     *
     * @return The path to the current row's parameter with any embedded macro(s)
     *         left in place; returns a blank if an instance of the table type
     *         doesn't exist or the row number is invalid. The path starts with the
     *         root table name. For structure tables the root name is followed by a
     *         comma and then the parent structure and variable name(s) that
     *         define(s) the table's path. Each parent and its associated variable
     *         name are separated by a period. Each parent/variable pair in the path
     *         is separated by a comma. The format is:
     *
    ...
    /**********************************************************************************************
     * Get the structure path to which the specified row's data belongs, showing
     * only the root structure and variable names and with any embedded macro
     ...
     *         replaced by its corresponding value; returns a blank if an instance
     *         of the table type doesn't exist or the row number is invalid. The
     *         path starts with the root table name. The root name is followed by a
     *         comma and then the variable name(s) that define(s) the table's path.
     *         Each variable in the path is separated by a comma. The format is:
     *
    ...
    /**********************************************************************************************
     * Get the structure path to which the specified row's data belongs, showing
     * only the root structure and variable names and with any embedded macro(s)
     * left in place
     *
     * @param row table data row index
     *
     ...
     *         left in place; returns a blank if an instance of the table type
     *         doesn't exist or the row number is invalid. The path starts with the
     *         root table name. The root name is followed by a comma and then the
     *         variable name(s) that define(s) the table's path. Each variable in
    ...
    /**********************************************************************************************
     * Get the structure path to which the specified row's data belongs, formatted
     * for use in an ITOS record statement and with any embedded macro replaced by
     * its corresponding value
     *
     * @param row table data row index
     *
     * @return The path to the current row's parameter formatted for use in an ITOS
     *         record statement and with any embedded macro replaced by its
     *         corresponding value; returns a blank if an instance of the table type
     *         doesn't exist or the row number is invalid. The path starts with the
     *         root table name. The root name is followed by a period and then the
     *         variable name(s) that define(s) the table's path. Each variable in
     *         the path is separated by a period. The format is:
     *
     *         rootTable[.variable1[.variable2[...]]]
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the structure path to which the specified row's data belongs, formatted
     * for use in an ITOS record statement, and with any embedded macro(s) left in
     * place
     *
     * @param row table data row index
     *
     ...
     *         returns a blank if an instance of the table type doesn't exist or the
     *         row number is invalid. The path starts with the root table name. The
     *         root name is followed by a period and then the variable name(s) that
     *         define(s) the table's path. Each variable in the path is separated by
     *         an period. The format is:
     *
     *         rootTable[.variable1[.variable2[...]]]
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the path or prototype table name for the table on the specified row in
     * the specified format
     *
     * @param tableType    table type (case insensitive). All structure table types
     *                     are combined and are referenced by the type name
     *                     "Structure", and all command table types are combined and
     *                     are referenced by the type name "Command"
     *
     * @param row          table data row index
     *
     * @param pathType     the format of the path to return:
     *                     TablePathType.VARIABLE_AND_PARENT to return the path with
     *                     the variable names and associated parent structure names,
     *                     TablePathType.PROTOTYPE to return the name of the
     *                     prototype table, TablePathType.VARIABLE_ONLY to return
     *                     the path with only the variable names (parent names
     *                     removed), or TablePathType.ITOS_RECORD to return the path
     ...
     *                     place
     *
     * @return The table path (or prototype name), for the structure table, to the
     *         current row's parameter; returns a blank if an instance of the
     *         structure table type doesn't exist or the row number is invalid.
     *         Depending on the input flag, any macro is replaced by its
    ...
    /**********************************************************************************************
     * Get the row index in the structure data for the first entry associated with
     * the parent structure of the entry on the specified row of the structure data.
     * The subsequent rows of the parent structure are not necessarily contiguous in
     * the structure data. If a variable in the structure has a structure data type
     * then the child structure's rows are inserted within the rows of the parent.
     * Use getStructurePathByRow() (or variant) to determine the structure to which
     * a specific row belongs
     *
     * @param row table data row index
     *
     * @return The row index in the structure data for the first entry associated
     *         with the parent structure of the entry on the specified row of the
     *         structure data; -1 if there is no parent associated with the
     *         specified row or no structure data exists
     *********************************************************************************************/
     ...
     *
     * @return true if the specified structure is referenced by more than one root
    ...
    /**********************************************************************************************
     * Determine if the specified structure is referenced by more than one root
     * structure, and that at least one of the structures is not associated with the
     * script
     *
     * @param structureName prototype name of the structure to check
     *
     * @return true if the specified structure is referenced by more than one root
     *         structure and at least one of these structures is not associated with
    ...
    /**********************************************************************************************
     * Determine if the specified structure is referenced by more than one root
     * structure. A flag is used to confine the check to structures not associated
     * with the script
     *
     * @param structureName prototype name of the structure to check
     *
     * @param isExternal    true to only check if the structure is shared by at
     *                      least one structure not associated with the script
     *
     * @return true if the specified structure is referenced by more than one root
     *         structure and, if the check is for external shared references, that
     *         the structure is shared with a root structure not associated with the
     ...
     *         structures are sorted alphabetically. The variables are displayed in
     *         the order of appearance within the structure (parent or child). Any
     *         macro is replaced by its corresponding value
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get an array containing the name, code, table, and argument name(s) for every
     * command in the project database
     *
     * @return Array containing the name, code, table, and argument name(s) for
     *         every command. The array is sorted by command name; if the same then
     *         by command code; if the same then by table name
     *********************************************************************************************/
     ...
     *
     * @param tableName name of the table, including the path if this table
     *                  references a structure, to which the field is a member
     *
     * @return Array of the data field names associated with the specified table;
     *         returns an empty array if the table name is invalid or the table has
     *         no data fields
     *********************************************************************************************/
     ...
     *
     * @return Array of the data field names associated with the specified group;
     *         returns an empty array if the group name is invalid or the group has
     *         no data fields
     *********************************************************************************************/
     ...
     *
     * @return Array of the data field names associated with the specified table
     *         type; returns an empty array if the table type name is invalid or the
     *         table type has no data fields
     *********************************************************************************************/
     ...
     *
     * @return Array of the data field names associated with the project; returns an
     *         empty array if the project has no data fields
     *********************************************************************************************/
     ...
     *
     * @return Array of the data field names associated with the specified owner;
     *         returns an empty array if the owner name is invalid or the owner has
     *         no data fields
     *********************************************************************************************/
     ...
     *
     * @return Array of table names and the data field value; returns an empty array
     *         if the field name is invalid (i.e., no table has the data field)
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the data field value for all structure tables that have the specified
     * data field
     *
     * @param fieldName data field name
     *
     * @return Array of structure table names and the data field value; returns an
     *         empty array if the field name is invalid (i.e., no structure table
     *         has the data field)
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the data field value for all command tables that have the specified data
     * field
     *
     * @param fieldName data field name
     *
     * @return Array of command table names and the data field value; returns an
     *         empty array if the field name is invalid (i.e., no command table has
     *         the data field)
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the data field value for all tables of the specified type that have the
     * specified data field
     *
     * @param tableType table type (case insensitive). All structure table types are
     *                  combined and are referenced by the type name "Structure",
     *                  and all command table types are combined and are referenced
     *                  by the type name "Command". null to include tables of any
     *                  type
     *
     * @param fieldName data field name
     *
     * @return Array of table names of the specified type and the data field value;
     *         returns an empty array if the field name is invalid (i.e., no table
     *         has the data field)
     *********************************************************************************************/
     ...
     *
     * @param tableName name of the table, including the path if this table
     *                  references a structure, for which the field is a member
     *
     * @param fieldName data field name
     *
     * @return Data field value; returns a null if the table name or field name is
     *         invalid
     *********************************************************************************************/
     ...
     * @param fieldName data field name
     *
     * @return Data field value; returns a null if the group name or field name is
     *         invalid
     *********************************************************************************************/
     ...
     * @param fieldName data field name
     *
     * @return Data field value; returns a null if the table type name or field name
     *         is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the contents of the data field for the specified table's specified data
     * field
     *
     * @param ownerName name of the data field owner (table name, including the path
     *                  if this table references a structure, group name, or table
     *                  type name)
     *
     * @param fieldName data field name
     *
     * @return Data field value; returns a null if the owner name or field name is
     *         invalid
     *********************************************************************************************/
     ...
     * @param fieldName data field name
     *
     * @return Data field description; returns a blank if the group name or field
     *         name is invalid
     *********************************************************************************************/
     ...
     * @param fieldName data field name
     *
     * @return Data field description; returns a blank if the table type name or
     ...
     * @param fieldName data field name
     *
     * @return Data field description; returns a blank if the project field name is
     *         invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the description of the data field for the specified owner's specified
     * data field
     *
     * @param ownerName name of the data field owner (table name, including the path
     *                  if this table references a structure, group name, or table
     ...
     * @param fieldName data field name
     *
     * @return Data field description; returns a blank if the owner name or field
     *         name is invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the structure table data at the row and column indicated, with any macro
     * replaced by its corresponding value. The column is specified by name.
     ...
     *         column name provided, with any macro replaced by its corresponding
     *         value; returns null if an instance of the structure table type, the
    ...
    /**********************************************************************************************
     * Get the command table data at the row and column indicated, with any macro
     * replaced by its corresponding value. The column is specified by name.
     * Convenience method that assumes the table type is "command"
     *
     * @param columnName column name (case insensitive)
     ...
     * @param row        table data row index
     *
     * @return Contents of the specified command table's array at the row and column
     *         name provided, with any macro replaced by its corresponding value;
     *         returns null if an instance of the command table type, the column
    ...
    /**********************************************************************************************
     * Get the data at the row and column indicated, with any macro replaced by its
     * corresponding value, for the table type specified. The column is specified by
     * name
     *
     * @param tableType  table type (case insensitive). All structure table types
     *                   are combined and are referenced by the type name
     ...
     * @param row        table data row index
     *
     * @return Contents of the specified table's array at the row and column name
     *         provided, with any macro replaced by its corresponding value; returns
     *         null if an instance of the table type, the column name, or the row
     *         doesn't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the structure table data at the row and column indicated, with any macro
     * name(s) left in place. The column is specified by name. Convenience method
     ...
     *
     * @return Contents of the specified structure table's array at the row and
     *         column name provided, with any macro name(s) left in place; returns
     *         null if an instance of the structure table type, the column name, or
     ...
     *
     * @return Contents of the specified command table's array at the row and column
     *         name provided, with any macro name(s) left in place; returns null if
     *         an instance of the command table type, the column name, or the row
     *         doesn't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the data at the row and column indicated, with any macro name(s) left in
     * place, for the table type specified. The column is specified by name
     *
     * @param tableType  table type (case insensitive). All structure table types
     *                   are combined and are referenced by the type name
     *                   "Structure", and all command table types are combined and
     ...
     *
     * @return Contents of the specified table's array at the row and column name
     *         provided, with any macro name(s) left in place; returns null if an
     *         instance of the table type, the column name, or the row doesn't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the data at the row and column indicated for the table type specified.
     * The column is specified by name. Macro expansion is controlled by the input
     * flag
     *
     * @param tableType    table type (case insensitive). All structure table types
     *                     are combined and are referenced by the type name
     ...
     *
     * @return Contents of the specified table's array at the row and column name
     *         provided; returns null if an instance of the table type, the column
     *         name, or the row doesn't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get an array of row numbers in the structure table data that belong to the
     * specified structure table. Convenience method that assumes the table type is
     * "Structure"
     *
     * @param tablePath full table path
     *
     * @return Array of the structure table data row numbers that belong to the
     *         specified structure table; returns an empty array if the structure
    ...
    /**********************************************************************************************
     * Get an array of row numbers in the command table data that belong to the
     * specified command table. Convenience method that assumes the table type is
     * "Command"
     *
     * @param tableName table name
     *
     * @return Array of the command table data row numbers that belong to the
     *         specified command table; returns an empty array if the command table
     *         name doesn't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get an array of row numbers in the table data for the specified table type
     * that belong to the specified table
     *
     * @param tableType table type (case insensitive). All structure table types are
     *                  combined and are referenced by the type name "Structure",
     *                  and all command table types are combined and are referenced
     ...
     * @param tablePath full table path
     *
     * @return Array of the specified table type's table data row numbers that
     *         belong to the specified table; returns an empty array if an instance
     *         of the table type or the table path doesn't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the data from the specified "Structure" table in the specified column for
     * the row with the specified variable name, with any macro name replaced by its
     * corresponding value. Convenience method that assumes the table type is
     * "Structure" and the variable name column is "Variable Name"
     *
     * @param tablePath    full table path, which includes the parent table name and
     *                     the data type + variable name pairs
     *
     * @param variableName variable name
     *
     * @param columnName   column name (case insensitive)
     *
     * @return Contents of the table defined by the table path, variable name, and
     *         column name specified, with any macro replaced by its corresponding
     *         value; returns null if an instance of the table type, the column
     *         name, or the variable name doesn't exist
     *********************************************************************************************/
     ...
     * matching column name that contains the matching name, with any macro name
     * replaced by its corresponding value
     *
     * @param tableType       table type (case insensitive). All structure table
     *                        types are combined and are referenced by the type name
     *                        "Structure", and all command table types are combined
     *                        and are referenced by the type name "Command"
     *
     * @param tablePath       full table path
     *
     * @param matchColumnName name of the column containing that matching name (case
     *                        insensitive)
     *
     * @param matchName       text to match in the matching column - this determines
     *                        the row. The first row in the matching column that
     *                        matches the matching name determines the row used to
     *                        retrieve the data value
     *
     * @param dataColumnName  name of the column from which to retrieve the data
     *                        value (case insensitive)
     *
     * @return Contents of the table defined by the table type, table path, matching
     *         column name, matching name, and data column name specified, with any
     *         macro replaced by its corresponding value; returns null if an
     *         instance of the table type, the matching column, the data column, or
    ...
    /**********************************************************************************************
     * Get the data from the specified "Structure" table in the specified column for
     * the row with the specified variable name, with any macro name(s) left in
     * place. Convenience method that assumes the table type is "Structure" and the
     * variable name column is "Variable Name"
     *
     * @param tablePath    full table path, which includes the parent table name and
     *                     the data type + variable name pairs
     *
     ...
     *
     * @return Contents of the table defined by the table path, variable name, and
     *         column name specified, with any macro name(s) left in place; returns
    ...
    /**********************************************************************************************
     * Get the data from the table in the specified column for the row in the
     * matching column name that contains the matching name, with any macro name(s)
     * left in place
     *
     * @param tableType       table type (case insensitive). All structure table
     *                        types are combined and are referenced by the type name
     ...
     * @return Contents of the table defined by the table type, table path, matching
     *         column name, matching name, and data column name specified, with any
     *         macro name(s) left in place; returns null if an instance of the table
     *         type, the matching column, the data column, or the matching name
     *         doesn't exist
     *********************************************************************************************/
     ...
     *
     * @param expandMacros    true to replace any macros with their corresponding
     *                        value; false to return the data with any macro names
     *                        in place
     *
     * @return Contents of the table defined by the table type, table path, matching
     *         column name, matching name, and data column name specified; returns
     *         null if an instance of the table type, the matching column, the data
            ...
            for (int row = 0; row < tableInfo.getData().length; row++) {
                ...
                if (matchColumnIndex != -1 && dataColumnIndex != -1) {
                    ...
                    if (tableInfo.getData()[row][tableInfo.getData()[row].length - PATH_COLUMN_DELTA].equals(tablePath)
                        ...
                        // Check if the data field contains a message name and ID
                        if (typeDefn.getInputTypes()[dataColumnIndex].equals(
     ...
     *
     * @param tableName table name, including the full path for child structure
     *                  tables
     *
     * @return Description of the specified table; returns a blank the table doesn't
     *         exist
     *********************************************************************************************/
     ...
     * @param row       table data row index
     *
     * @return Description of the specified table at the row provided; returns a
     *         blank if an instance of the table type or the row doesn't exist
     *********************************************************************************************/
     ...
     * header and icon indicate that the text describes information useful to the
     * user; e.g., script status. The Okay button must be pressed before the script
     * can continue
     *
    ...
    /**********************************************************************************************
     * Display a warning dialog showing the supplied text. The dialog’s header and
     * icon indicate that the text describes an warning condition. The Okay button
     * must be pressed before the script can continue
     *
     * @param text text to display in the dialog
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Display an error dialog showing the supplied text. The dialog’s header and
     * icon indicate that the text describes an error condition. The Okay button
     * must be pressed before the script can continue
     *
     * @param text text to display in the dialog
     *********************************************************************************************/
     ...
     * accept the input, or Cancel to close the dialog without accepting the input
     *
     * @param labelText text to display in the dialog
     *
     * @return The text entered in the dialog input field if the Okay button is
     *         pressed; returns null if no text or white space is entered, or if the
    ...
    /**********************************************************************************************
     * Display a dialog containing radio buttons. The radio buttons are mutually
     * exclusive; only one can be selected at a time. The user must press the Okay
     * button to accept the radio button input, or Cancel to close the dialog
     * without accepting the input
     *
     * @param label      text to display above the radio buttons
     *
     * @param buttonInfo array containing the text and optional descriptions for the
     *                   radio buttons to display in the dialog
     *
     * @return The text for the selected radio button if the Okay button is pressed;
     *         returns null if no radio button is selected or if the Cancel button
     *         is pressed
     *********************************************************************************************/
    public String getRadioButtonDialog(String label, String[][] buttonInfo) {
        ...
        if (dialog.addRadioButtons(null, false, buttonInfo, null, label, false, panel, gbc) && dialog
                .showOptionsDialog(parent, panel, "Select", DialogOption.OK_CANCEL_OPTION, true) == OK_BUTTON) {
    ...
    /**********************************************************************************************
     * Display a dialog containing one or more check boxes. The user must press the
     * Okay button to accept the check box input(s), or Cancel to close the dialog
     * without accepting the input
     *
     * @param label   text to display above the check boxes
     *
     * @param boxInfo array containing the text and optional descriptions for the
    ...
    public boolean[] getCheckBoxDialog(String label, String[][] boxInfo) {
        ...
        if (boxInfo != null && boxInfo.length != 0) {
            ...
            if (dialog.addCheckBoxes(null, boxInfo, null, label, false, panel) && dialog.showOptionsDialog(parent,
                    panel, "Select", DialogOption.OK_CANCEL_OPTION, true) == OK_BUTTON) {
     ...
     * enumeration value/label separator character and the enumerated pair separator
     * character are automatically determined. Any leading or trailing white space
     * characters are removed from each array member
     *
     ...
     *         returns null if the input text is empty or the enumeration separator
     ...
     * character or string, and trim any leading or trailing white space characters
     * from each array member
     *
     * @param text            string to separate into an array
     *
     * @param columnSeparator character string to use to delineate the separation
     *                        point(s) between columns. The separator is eliminated
     *                        from the array members
     *
     * @return Array representing the substrings in the supplied text after being
    ...
    /**********************************************************************************************
     * Divide the supplied string into a two-dimensional array (columns and rows)
     * using the supplied separator characters or strings, and trim any leading or
     * trailing white space characters from each array member
     *
     * @param text            string to separate into an array
     *
     * @param columnSeparator character string to use to delineate the separation
     ...
     *                        from the array members
     *
     * @param rowSeparator    character string to use to delineate the separation
     *                        point(s) between rows. The separator is eliminated
     *                        from the array members. Use null if only one row is
     *                        supplied
     *
     * @return Two-dimensional array representing the substrings in the supplied
     *         text after being parsed using the separator; returns null if the
     *         input text is empty
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Open the specified file for writing. The PrintWriter object that is returned
     * is used by the file writing methods to specify the output file
     *
     ...
     *
     * @param printWriter output file PrintWriter object obtained from the
    ...
    /**********************************************************************************************
     * Write the supplied formatted text in the indicated format to the specified
     ...
     *
     * @param args        variable list of arguments referenced by the format
     ...
     *
     * @return Array containing the data field information for the project; an empty
     *         array if the project has no data fields. The array in is the format:
     *         field name, description, size, input type, required (true or false),
     *         applicability, value[,...]
     *********************************************************************************************/
    public String[][] getProjectFields() {
        ...
        for (FieldInformation fieldInfo : fieldHandler
            ...
            projectFields.add(new String[] { fieldInfo.getFieldName(), fieldInfo.getDescription(),
                    Integer.toString(fieldInfo.getSize()), fieldInfo.getInputType().getInputName(),
                    Boolean.toString(fieldInfo.isRequired()), fieldInfo.getApplicabilityType().getApplicabilityName(),
                    fieldInfo.getValue() });
        }
     ...
     *
     * @return Link description; returns a blank if the data stream or link don't
     *         exist, or the link has no description
     *********************************************************************************************/
     ...
     * @param linkName   link name
     *
     * @return Text representation of the sample rate, in samples per second, of the
     *         specified link. For rates equal to or faster than 1 sample per second
     *         the string represents a whole number; for rates slower than 1 sample
     *         per second the string is in the form number of samples / number of
     *         seconds; returns a blank if the data stream or link don't exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the array of data stream and link names to which the specified variable
     * belongs
     *
     ...
     * structure. The variable's path, including parent structure and variable name,
     * is used to verify that the specified target has been located; i.e., not
     * another variable with the same name
     *
     * @param path a comma separated string of the parent structure and each data
     ...
     * associated with the link entries. Each application name appears only once in
     * the array
     *
     * @param dataFieldName name of the application name data field
     *
     * @return Array containing the contents of the specified CFS application name
     *         data field associated with each of the tables referenced by the link
     *         entries
     *********************************************************************************************/
     ...
     *
     * @param applicationOnly true if only those groups that represent a CFS
     *                        application should be returned
     *
     * @return Array of group names (application groups only if the input flag is
     *         true); empty array if no groups are defined
     *********************************************************************************************/
     ...
     * @param groupName group name
     *
     * @return Array containing the table members for the specified group; an empty
     *         array if the group has no table members or the group doesn't exist
     *********************************************************************************************/
     ...
     * @param groupName group name
     *
     * @return Array containing the data field information for the specified group;
     *         an empty array if the group has no data fields or the group doesn't
     *         exist, or null if the group handler isn't active. The array in is the
     *         format: field name, description, size, input type, required (true or
     *         false), applicability, value[,...]
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the copy table for the messages of the specified data stream. Any macro
     * embedded in a variable name is replaced by its corresponding value
     *
     * @param streamName         data stream name
     *
     * @param headerSize         size of the message header in bytes. For example,
     *                           the CCSDS header size is 12
     *
     * @param messageIDNameField name of the message ID name data field (e.g.,
     *                           'Message ID name')
     *
     * @param optimize           true to combine memory copy calls for consecutive
     *                           variables in the copy table
     *
     * @return Array containing the copy table entries; returns blank if there are
     *         no entries for the specified data stream or if data stream name is
     *         invalid. Any macro embedded in a variable name is replaced by its
     *         corresponding value
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the copy table for the messages of the specified data stream. Any macro
     * embedded in a variable name is left in place
     *
     * @param streamName         data stream name
     *
     * @param headerSize         size of the message header in bytes. For example,
     ...
     *                           variables in the copy table
     *
     * @return Array containing the copy table entries with any macro embedded in a
     *         variable name left in place; returns blank if there are no entries
     *         for the specified data stream or if data stream name is invalid
     *********************************************************************************************/
     ...
     * @param streamName    data stream name
     *
     * @param headerSize    size of the message header in bytes. For example, the
     *                      CCSDS header size is 12
     *
     * @param tlmMessageIDs array containing string array entries giving the
     *                      structure table path+name and the table's associated
     *                      message ID name
     *
     * @param optimize      true to combine memory copy calls for consecutive
     *                      variables in the copy table
     ...
     *         corresponding value
     *********************************************************************************************/
    public String[][] getCopyTableEntries(String streamName, int headerSize, String[][] tlmMessageIDs,
            boolean optimize) {
    ...
    /**********************************************************************************************
     * Get the copy table message names and their corresponding ID values for the
     * specified data stream
     *
     * @param streamName data stream name
     *
     * @return Array containing the copy table message names and ID values; returns
    ...
    /**********************************************************************************************
     * Get an array containing every message owner, name, and ID from every table
     * cell, data field (table or group), and telemetry message. Message names and
     * IDs are determined by the input type assigned to the table column or data
     * field
     *
     * @return Two-dimensional array containing every message owner, name, and ID,
     *         sorted by the owner name. Each row in the array is an array in the
     *         form [owner name], [message name], [message ID]. The owner name is
     *         preceded by 'Group:' if the owner is a group, and by "Tlm:' if the
     *         owner is a telemetry message
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Parse the supplied string containing a message name and ID into an array with
     * the name in index 0 and the ID in index 1 (depending on the input string
     * either or both may be blank). If only the name or ID is present in the
     * supplied string the output is based on if the string evaluates to a
     * hexadecimal value (treated as the ID; name is blank) or not (treated as the
     * name; ID is blank)
     *
     * @param msgNameAndID message name and ID in the format [&lt;message name&gt;]
     *                     [&lt;message ID&gt;]
     *
     * @return One-dimensional array containing the message name in index 0 and the
     *         ID in index 1 (depending on the input string either or both may be
     *         blank)
     *********************************************************************************************/
     ...
     *
     * @return Array of application names; the list is empty if no application names
     *         exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the integer array containing the size of each array dimension from the
     * supplied array size string
     *
     * @param arrayString array size in the format
     *                    {@literal [#]<[#]<...>> or #<,#<...>>}
     *
    ...
    /**********************************************************************************************
     * Convert an integer array containing the size of each array dimension into a
     * string in the format {@literal [#]<[#]<...>>}
     *
     * @param arrayIndex array of integers containing the size of each array
     *                   dimension
     *
    ...
    /**********************************************************************************************
     * Export the tables in XTCE XML format to the specified file. This is the main
     * entry point when using a script association to perform the export. It calls
     * the internal method to set up and parse the tables for export
     *
     ...
     *
     * @param validationStatus  validation status attribute (for the space system
     *                          headers)
     *
     * @param classification1   first level classification attribute (for the space
     *                          system headers)
     *
     * @param classification2   second level classification attribute (for the space
     *                          system headers)
     *
     * @param classification3   third level classification attribute (for the space
     *                          system headers)
     *
     * @return true if an error occurred preventing exporting the project to the
     *         file
     *********************************************************************************************/
    public boolean xtceExport(String outputFileName, boolean isBigEndian, boolean isHeaderBigEndian, String version,
            String validationStatus, String classification1, String classification2, String classification3) {
        ...
        try {
            ...
            xtceHandler.exportTables(new FileEnvVar(outputFileName), getTableNames(), true, true, // unused for XTCE
                                                                                                  // export
    ...
    public void xtceAddSpaceSystemParameters(SpaceSystemType spaceSystem, String tableName, String[][] tableData,
        ...
        if (xtceHandler != null) {
            xtceHandler.addSpaceSystemParameters(spaceSystem, tableName, tableData, varColumn, typeColumn, sizeColumn,
                    bitColumn, enumColumn, descColumn, unitsColumn, minColumn, maxColumn, isTlmHdrTable, tlmHdrSysPath,
                    isRootStructure, applicationID);
        }
    }
     ...
     *
     * @param argArraySizes list of of command argument array sizes; the list item
    ...
    public void xtceAddCommand(SpaceSystemType spaceSystem, String commandName, String cmdFuncCode,
            ...
            String[] argumentNames, String[] argDataTypes, String[] argArraySizes, String description)
    ...
    public NameDescriptionType xtceSetArgumentDataType(SpaceSystemType spaceSystem, String argumentName,
            String dataType, String arraySize, String bitLength, String enumeration, String units, String minimum,
            String maximum, String description, int stringSize, String uniqueID) throws CCDDException {
        ...
        if (xtceHandler != null) {
            commandDescription = xtceHandler.setArgumentDataType(spaceSystem, argumentName, dataType, arraySize,
                    bitLength, enumeration, units, minimum, maximum, description, stringSize, uniqueID);
        }
     ...
     *                       method
     *********************************************************************************************/
    public void xtceAddContainerReference(String parameterName, String dataType, String arraySize, Object entryList)
            throws CCDDException {
        // Check if the XTCE handler exists
        if (xtceHandler != null) {
     ...
     *********************************************************************************************/
    public EnumerationList xtceCreateEnumerationList(SpaceSystemType spaceSystem, String enumeration) {
