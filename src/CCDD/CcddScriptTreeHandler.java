...
public class CcddScriptTreeHandler extends CcddInformationTreeHandler {
     ...
     * @param parent   GUI component over which to center any error dialog
     *
     * @return List of scripts stored in the project database. An empty list if no
     ...
     *
     * @param undoHandler   reference to the undo handler. This is not used for the
     *                      script tree
     *
     ...
     *                    slash. This is not used for the script tree
     *
