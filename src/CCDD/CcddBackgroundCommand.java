...
public class CcddBackgroundCommand
{
    ...
    /**********************************************************************************************
     * Class for executing a command in the background. Consists of two user-provided methods: A command
     * execution method that is run in the background (this method must be supplied), and a command
     * completed method that is run after the execute method ends (this method can be omitted if no
    ...
    /**********************************************************************************************
     * Execute a command in the background. The mouse cursor for the main window is set to the 'wait'
     * cursor and the main window's menu items are disabled for the duration of the command execution.
    ...
    /**********************************************************************************************
     * Execute a command in the background. The mouse cursor for the specified component is set to the
