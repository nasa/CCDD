...
public class CcddDbCommandHandler {
     ...
     * @param component GUI component over which to center any error dialog
     *
     * @return Command result row count; returns null if no connection exists to the
     *         server
     *
     * @throws SQLException If no connection exists to the server
     *********************************************************************************************/
     ...
     * @param component GUI component over which to center any error dialog
     *
     * @return true if the first result is a ResultSet object, or false if it is an
     ...
     * @param component   GUI component over which to center any error dialog
     *
     * @return Command result (content is dependent on the command type); returns
    ...
    /**********************************************************************************************
     * Retrieve a list from the server or database. The command strings are set up
