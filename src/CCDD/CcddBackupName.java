...
public final class CcddBackupName
{
    ...
    /**********************************************************************************************
     * Take the full path to the backup file and remove the file name portion. Take the user selected
     * file name and append this a the initial path. Note: This is to handle cases where there are
     * spaces entered into the filename
     *
     * @param selectedPaths        Array containing file paths
     * @param chosenBackupFileName User selected backup file name
     * @return A reconstructed path with the expected backup filename at the expected location or null
     *         on error
     **********************************************************************************************/
    public static final FileEnvVar reconstructBackupFilePath(FileEnvVar[] selectedPaths, String chosenBackupFileName)
    {
    ...
    /**********************************************************************************************
     * Take in a string of type [ID]_[DATE-TIME-STAMP].[EXT] -Note:[DATE-TIME-STAMP] is optional Strip
     * _[DATE-TIME-STAMP].[EXT] and return the [ID] Note: If an error in the chosenBackupFileName is
     * detected, a failsafe result will be returned. If a null string is entered, an exception will be
     * thrown
     *
     ...
     * @return [ID]
     **********************************************************************************************/
    public static String removeExtensionTimeStamp(String extension, String dateTimeFormat, String chosenBackupFileName,
