/**
 * CFS Command & Data Dictionary table editor handler. Copyright 2017 United
...
public class CcddTableEditorHandler extends CcddEditorPanelHandler
{
    ...
    // enumeration, and rate columns (in model coordinates), if present. Also
     ...
     *************************************************************************/
    protected void setCommittedInformation(TableInformation info)
    {
    ...
    private void initialize()
    {
        ...
        table = new CcddJTableHandler(INITIAL_VIEWABLE_DATA_TABLE_ROWS)
        {
            ...
            protected boolean isTableChanged(Object[][] data)
            {
                ...
                return super.isTableChanged(data)
                       || isFieldChanged
