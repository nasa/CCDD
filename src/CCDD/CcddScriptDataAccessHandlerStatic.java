...
*
*   \brief
*     Class containing the static method references to the methods in the
...
/**************************************************************************************************
 * CFS Command and Data Dictionary static script data access class. This class
 * contains static public methods that are accessible to the data output scripts
 *************************************************************************************************/
public class CcddScriptDataAccessHandlerStatic {
    ...
    public static void xtceAddSpaceSystemHeader(SpaceSystemType spaceSystem, String classification,
            String validationStatus, String version, String date) throws CCDDException {
    ...
    public static boolean xtceAddParameterSequenceEntry(SpaceSystemType spaceSystem, String parameterName,
            String dataType, String arraySize, EntryListType entryList, boolean isTlmHdrRef) throws CCDDException {
    ...
    protected static void xtceAddSpaceSystemCommands(SpaceSystemType spaceSystem, String[][] tableData,
            int cmdNameColumn, int cmdCodeColumn, int cmdArgumentColumn, int cmdDescColumn, boolean isCmdHeader,
            String cmdHdrSysPath, String applicationID) throws CCDDException {
        accessHandler.xtceAddSpaceSystemCommands(spaceSystem, tableData, cmdNameColumn, cmdCodeColumn,
                cmdArgumentColumn, cmdDescColumn, isCmdHeader, cmdHdrSysPath, applicationID);
    }
    ...
    public static NameDescriptionType xtceSetArgumentDataType(SpaceSystemType spaceSystem, String argumentName,
        ...
        return accessHandler.xtceSetArgumentDataType(spaceSystem, argumentName, dataType, arraySize, bitLength,
                enumeration, units, minimum, maximum, description, stringSize, uniqueID);
    }
