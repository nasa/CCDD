...
/**************************************************************************************************
 * CFS Command and Data Dictionary table type handler class. The table
 * definition consists of one or more table types, each with its associated
 * column name(s) and file definition(s), and the value required status of the
 * columns
 *************************************************************************************************/
public class CcddTableTypeHandler {
    ...
    protected class TypeDefinition {
        ...
        /******************************************************************************************
         * Get the table type data for the type editor. The primary key and row index
         * column definitions (the first two rows) are ignored so that these aren't
         * displayed in the type editor
         *
        ...
        /******************************************************************************************
         * Get the array of column names as used in the database, surrounded by double
         * quotes if the name matches a PostgreSQL key word
         *
         * @return Array of column names as used in the database, surrounded by double
         *         quotes if the name matches a PostgreSQL key word
         *****************************************************************************************/
        ...
        /******************************************************************************************
         * Convert the visible column names to their database equivalents. The database
         * column name is the visible name with any characters that are invalid in a
         * database column name replaced with an underscore; however, if the table type
         * represents a structure then certain column names use fixed values
         *****************************************************************************************/
        ...
        /******************************************************************************************
         * Get the array of column names as seen by the user (includes names for hidden
         * columns)
         *
         ...
         *
         * @return Index of the first column of the specified input type; -1 if no
         ...
         *
         * @return Index of the first column of the specified default input type; -1 if
         ...
         * @param inputType column input type (InputType)
         *
         * @return List containing the index (or indices) of the column(s) of the
         *         specified input type; an empty list if no column of the specified
         *         type is found
         *****************************************************************************************/
        ...
        /******************************************************************************************
         * Get the index or indices of the column(s) having the specified default input
         * type
         *
         * @param inputType column input type (DefaultInputType)
         *
         * @return List containing the index (or indices) of the column(s) of the
         *         specified default input type; an empty list if no column of the
         ...
         * @param inputType column input type (InputType)
         *
         * @return Visible name of the first column with the specified input type; null
         *         if no column of the specified type is found
         *****************************************************************************************/
        ...
        /******************************************************************************************
         * Get the visible name of the first column having the specified default input
         * type
         *
         * @param inputType column input type (DefaultInputType)
         *
         * @return Visible name of the first column with the specified default input
         ...
         * @param inputType column input type (InputType)
         *
         * @return Database name of the first column with the specified input type; null
         *         if no column of the specified type is found
         *****************************************************************************************/
        ...
        /******************************************************************************************
         * Get the database name of the first column having the specified default input
         * type
         *
         * @param inputType column input type (DefaultInputType)
         *
         * @return Database name of the first column with the specified default input
         *         type; null if no column of the specified type is found
         *****************************************************************************************/
         ...
         *
         * @return Index of the first column of the specified input type format; -1 if
         ...
         *
         * @return List containing the index (or indices) of the column(s) of the
         *         specified input type format; an empty list if no column of the
         ...
         * @param inputFormat column input type format (InputTypeFormat)
         *
         * @return Visible name of the first column with the specified input type
         *         format; null if no column of the specified format is found
         *****************************************************************************************/
         ...
         * @param inputFormat column input type format (InputTypeFormat)
         *
         * @return Database name of the first column with the specified input type
         *         format; null if no column of the specified format is found
         *****************************************************************************************/
        ...
        /******************************************************************************************
         * Get the viewable index of the column having the specified name. This index
         * accounts for the hidden columns, primary key and row index
         *
         * @param columnName column name (as seen by the user)
         *
         * @return Column name view index; -1 if no column of the specified name is
         *         found
         *****************************************************************************************/
         ...
         *
         * @param visibleName      name of the column as seen by the user; e.g., as
         *                         table editor column headers
         *
         * @param comment          column description used as the table editor column
         *                         header tool tip text
         *
         * @param inputType        column input type (InputType)
         *
         * @param isRowValueUnique true if the each row value in the column must have a
         *                         unique value
         *
         * @param isColumnRequired true if the column must have a value when the type is
         *                         committed to the database
         *
         * @param isStructure      true if the the column applies to structure data
         *                         types
         *
        ...
        protected void addColumn(int index, String databaseName, String visibleName, String comment,
                InputType inputType, Boolean isRowValueUnique, Boolean isColumnRequired, Boolean isStructure,
                Boolean isPointer) {
         ...
         * the Structure table type
         *
         * @return true if this table type contains all of the protected columns of the
         *         Structure table type; i.e., this table type represents a structure
         *         table
         *****************************************************************************************/
         ...
         *
         * @return true if this table type contains all of the protected columns of the
         *         ENUM table type; i.e., this table type represents a ENUM
         *         table
         *****************************************************************************************/
        ...
        /******************************************************************************************
         * Determine if this table type contains all of the default protected columns of
         * the Structure table type in addition to a column with the Rate input type
         *
         * @return true if this table type contains all of the protected columns of the
         *         Structure table type in addition to a column with the Rate input
         *         type; i.e., this table type represents a telemetry structure table
         *****************************************************************************************/
        ...
        /******************************************************************************************
         * Determine if this table type contains all of the default protected columns of
         * the Command table type
         *
         * @return true if this table type contains all of the protected columns of the
         *         Command table type (but not those of a Structure table type); i.e.,
         *         this table type represents a Command table
         *****************************************************************************************/
         ...
         *
         * @param typeName table type name of the default table type with which to
        ...
        private boolean isTargetType(String typeName) {
            ...
            for (DefaultColumn column : DefaultColumn.values()) {
                ...
                if (column.getTableType().equals(typeName) && column.isProtected() && getColumnIndicesByInputType(
                        inputTypeHandler.getInputTypeByDefaultType(column.getInputType())).isEmpty()) {
    ...
    /**********************************************************************************************
     * Create a new table type definition and add it to the list of type
     * definitions. If the definition exists then replace it with the new one
     *
     * @param typeName    table type name
     *
     * @param description table type description
    ...
    protected TypeDefinition createTypeDefinition(String typeName, String description, Object[][] typeData) {
        ...
        typeDefn.addColumn(DefaultColumn.PRIMARY_KEY.ordinal(), DefaultColumn.PRIMARY_KEY.getDbName(),
                ...
                DefaultColumn.PRIMARY_KEY.isStructureAllowed(), DefaultColumn.PRIMARY_KEY.isPointerAllowed());
        ...
        for (int row = 0; row < typeData.length; row++) {
            ...
            typeDefn.addColumn(row, (String) typeData[row][TableTypeEditorColumnInfo.NAME.ordinal()],
                    ...
                    inputTypeHandler.getInputTypeByName(
                            typeData[row][TableTypeEditorColumnInfo.INPUT_TYPE.ordinal()].toString()),
     ...
     * @param typeName table type name
     *
     * @return Table type definition based on the supplied type name; null if no
     *         match is found
     *********************************************************************************************/
     ...
     *
     * @return Array of names of the table types, sorted alphabetically; an empty
     *         list if no table types are defined
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Convert the visible column name to its database equivalent by replacing all
     * characters that are invalid in a database column name with underscores. If
     * the column belongs to a table representing a structure the specific input
     * types use predefined names in place of the conversion name. If the column
     * name matches a PostgreSQL reserved word then the name is bounded by double
     * quotes
     *
     * @param columnName    column name (as seen by the user)
     *
     ...
     * @param typeName table type name
     *
     * @return String containing the column indices separated by colons; blank if
     *         the type in invalid
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the name of the first column in the specified table type's definition
     * that matches the specified input type
     *
     * @param typeName  table type name
     *
     * @param inputType column input type (InputType)
     *
     * @return Name (as seen by the user) of the first column in the specified table
     *         type's definition that matches the specified input type; null if the
     *         input type doesn't exist in the table type definition
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Get the name of the first column in the specified table type's definition
     * that matches the specified default input type
     *
     * @param typeName  table type name
     *
     * @param inputType column input type (DefaultInputType)
     *
     * @return Name (as seen by the user) of the first column in the specified table
     *         type's definition that matches the specified default input type; null
     *         if the input type doesn't exist in the table type definition
     *********************************************************************************************/
     ...
     *
     * @param useDbName true to use the database column name; false to use the user
     *                  column name
     *
     * @return List of unique structure table enumeration column names; an empty
     *         list if no enumeration columns exist
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Update the input type for each table type definition column following a
     * change to the input type definitions
     *
    ...
    /**********************************************************************************************
     * Check if the specified table types are new or match an existing one. If new
     * then add the table type. If the table type name matches then compare the type
     ...
     *         definitions differ
     *
     * @throws CCDDException If an imported data field name will cause an existing
     ...
     *
     * @return TableTypeUpdate.NEW if the table type is new, TableTypeUpdate.MATCH
     *         if the table type matches an existing one, or
     *         TableTypeUpdate.MISMATCH if the table type name matches an existing
     *         one but the type definition differs
     *
     * @throws CCDDException If an imported data field name will cause an existing
     *                       table's field to be renamed and the user elects to
     *                       cancel the update
